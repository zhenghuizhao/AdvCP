...
parser.add_argument("--model_path", default="/data/zhenghui.zhao/Code/MICloss/transwcd_micloss/results/test_models/2023-10-15-20-14_11600_0.7418.pth", type=str, help="model_path")

parser.add_argument("--pooling", default="gmp", type=str, help="pooling method")
parser.add_argument("--bkg_score", default=0.2, type=float, help="bkg_score")
...
def test(model, dataset, test_scales=1.0):
    ...
    with torch.no_grad(), torch.cuda.device(0):
        ...
        for idx, data in tqdm(enumerate(data_loader)):
            ...
            label_with_fn_fp_path = args.save_dir + '/prediction_color_3000iter/' + name[0] + '.png'
...
def main(cfg):
    ...
    for k, v in trained_state_dict.items():
        # if 'diff.0.bias' in k:
        #     k = k.replace('diff.0.bias', 'diff_c4.0.bias')
        # if 'diff.0.weight' in k:
        #     k = k.replace('diff.0.weight', 'diff_c4.0.weight')
        new_state_dict[k] = v
